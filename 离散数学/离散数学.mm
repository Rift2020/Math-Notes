...
<node TEXT="*集合的基数" ID="ID_993146036" CREATED="1642992745260" MODIFIED="1642992756016">
<node TEXT="我们使用集合的个数来衡量有限集的大小，但对于无限集，个数无从描述，因而使用基数" ID="ID_530248248" CREATED="1642992794279" MODIFIED="1642992837136"/>
<node TEXT="定义" ID="ID_1717156647" CREATED="1642992837539" MODIFIED="1642992842068">
<node TEXT="集合A与集合B具有相同的基数，当且仅当存在一个从A到B的一一对应，写作|A|=|B|" ID="ID_1446650796" CREATED="1642992842418" MODIFIED="1642992931383"/>
<node TEXT="\latex 如若存在A到B的一对一函数，则$|A|\leq |B|$" ID="ID_1119452764" CREATED="1642992942451" MODIFIED="1642993042456"/>
</node>
<node TEXT="可数集" ID="ID_1509121049" CREATED="1642993060116" MODIFIED="1642993085820">
<node TEXT="\latex 若一个无限集与自然数集有相同的基数则称为可数的，\\若一个集是有限集或者自然数集则称为至多可数的。\\用$|S|=\aleph_0$表示集合S是可数的，念作S有基数“阿里夫0”" ID="ID_1467156891" CREATED="1642993165711" MODIFIED="1642993320009">
<node TEXT="实际上，整数集，有理数集都是可数的" ID="ID_1398152114" CREATED="1642993341023" MODIFIED="1642993362214"/>
</node>
<node TEXT="而可数也可以叫作可列，因为可数集的元素可以以某种形式排成一列" ID="ID_74304257" CREATED="1642993444562" MODIFIED="1642993476296">
<node TEXT="康托尔对角线法" ID="ID_1536705614" CREATED="1642993476653" MODIFIED="1642993489826"/>
</node>
</node>
<node TEXT="不可数集" ID="ID_63121015" CREATED="1642993512206" MODIFIED="1642993515088">
<node TEXT="如果一个集合既不是有限的也不是可数的，就称为不可数集" ID="ID_5972953" CREATED="1642993546185" MODIFIED="1642993561596">
<node TEXT="实数是不可数集" ID="ID_1438256809" CREATED="1642993595602" MODIFIED="1642993609198"/>
</node>
</node>
<node TEXT="康托尔-伯恩斯坦定理（Cantor-Bernstein theorem）" ID="ID_1011220857" CREATED="1642993769479" MODIFIED="1642993770498">
<node TEXT="\latex 如若$|A|\leq |B|且|B|\leq|A|则|A|=|B|$\\换言之，如若存在一对一函数f，g是分别从A到B的和从B到A的，\\则存在A和B之间的一一对应函数" ID="ID_643415761" CREATED="1642993770952" MODIFIED="1642993923836">
<node TEXT="看起来很简单实则证明非常复杂" ID="ID_1610092897" CREATED="1642993929170" MODIFIED="1642993940037"/>
</node>
</node>
<node TEXT="可计算与不可计算" ID="ID_1618671148" CREATED="1642995123380" MODIFIED="1642995130499">
<node TEXT="存在一些不可计算函数，即使有无穷多的时间和空间，也没有计算机程序能够计算它" ID="ID_1968452804" CREATED="1642995735314" MODIFIED="1642995786855"/>
</node>
<node TEXT="连续统假设" ID="ID_1122759161" CREATED="1642995353325" MODIFIED="1642995363434">
<node TEXT="前置" ID="ID_1202164198" CREATED="1642995364524" MODIFIED="1642995371247">
<node TEXT="\latex 可以证明$Z^+$的幂集和实数集具有相同的基数，即$|P(Z^+)|=|R|$" ID="ID_162085529" CREATED="1642995371892" MODIFIED="1642995519635"/>
<node TEXT="集合的基数总是小于其幂集的基数" ID="ID_328994982" CREATED="1642995536244" MODIFIED="1642995550134"/>
</node>
<node TEXT="内容" ID="ID_259413260" CREATED="1642995557015" MODIFIED="1642995604121">
<node TEXT="\latex 不存在一个集合A使得$\aleph_0&lt;|A|&lt;|R|$" ID="ID_1194112544" CREATED="1642995604343" MODIFIED="1642995665958">
<node TEXT="然而已经证明了：在标准集合论公理下，该命题既不能被证明也不能被推翻" ID="ID_1753261902" CREATED="1642995687255" MODIFIED="1642995720443"/>
</node>
</node>
</node>
</node>
